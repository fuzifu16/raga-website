...
const PRODUCTS = {
  ...
  "rqm3": {
    ...
    category: "直行程",
    tag: "调节型",
    desc: "RQⅢ100大转矩多回转调节型智能执行机构，支持4~20mA模拟量控制及开关型控制，适用于大口径阀门及重载工业过程控制场景。防护等级IP68。",
    desc_en: "RQⅢ100 series large torque multi-turn modulating intelligent actuator, supports 4~20mA analog control and switch control.",
    desc_ru: "RQⅢ100 серия большого момента многооборотный регулирующий интеллектуальный актуатор.",
    specs: [
      ["型号", "RQⅢ100"],
      ["类型", "多回转调节型"],
  ...
  "rq150": {
    ...
    category: "直行程",
    tag: "第三代",
    desc: "RQⅢ150~RQ300超大型多回转调节型智能执行机构，支持4~20mA模拟量控制及开关型控制，适用于超大口径重载阀门及工业过程控制场景。防护等级IP68。",
    desc_en: "RQⅢ150~RQ300 series extra-large multi-turn modulating intelligent actuator, suitable for extra-large caliber heavy-duty valves.",
    desc_ru: "RQⅢ150~RQ300 серия сверхкрупный многооборотный регулирующий интеллектуальный актуатор.",
    specs: [
  ...
  "rq3": {
    ...
    category: "直行程",
    tag: "智能型",
    desc: "RQⅢ020/RQⅢ030/RQⅢ040中型多回转调节型执行机构，集现场控制和远程控制于一体。具备非侵入式设定、图形化显示、智能诊断等先进功能。适用于各类多回转调节型阀门控制。",
    desc_en: "RQⅢ 020~040 series medium multi-turn modulating actuator, integrates field control and remote control.",
    desc_ru: "RQⅢ 020~040 серия средний многооборотный регулирующий актуатор.",
    specs: [
  ...
  "rq060": {
    ...
    category: "直行程",
    tag: "智能型",
    desc: "RQⅢ060大型多回转调节型智能执行机构，适用于大口径阀门控制。具备非侵入式设定、图形化显示、智能诊断等先进功能，防护等级IP68。",
    desc_en: "RQⅢ 060 series large multi-turn modulating intelligent actuator, suitable for large caliber valve control.",
    desc_ru: "RQⅢ 060 серия крупный многооборотный регулирующий интеллектуальный актуатор.",
    specs: [
      ["型号", "RQⅢ060"],
  ...
  "ra3": {
    id: "ra3",
    name: "RQⅢ 003~014系列",
    image: "images/RQIII-003-014.png",
    category: "直行程",
    tag: "智能型",
    desc: "RQⅢ003~014系列智能型多回转调节型电动执行机构，集非侵入式设定、图形化显示、智能诊断等先进功能于一体。适用于小型阀门控制，防护等级IP68。",
    desc_en: "RQⅢ 003~014 series intelligent multi-turn modulating electric actuator, integrates non-intrusive setting.",
    desc_ru: "RQⅢ 003~014 серия интеллектуальный многооборотный регулирующий электрический актуатор.",
    specs: [
